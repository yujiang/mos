...
for _,g in ipairs({'coroutine', 'debug', 'io', 'math', 'string', 'table', 'os'}) do
  if G[g] and type(G[g]) == "table" then for k,v in pairs(G[g]) do globals[v] = g..'.'..k end end end
...
return { _NAME = n, _COPYRIGHT = c, _DESCRIPTION = d, _VERSION = v, serialize = s,
  ...
  short = function(a, opts) return s(a, merge({sortkeys = false, comment = false}, opts)) end,}
